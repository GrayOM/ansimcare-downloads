...
현재 배포본은 ARM64 갤럭시 시험 기기용 사전 릴리스 APK입니다. 앱은 환자 또는 보호자가 설치한 뒤 동의 절차를 완료하면 중앙 관제 등록을 요청하도록 설계되어 있습니다. 환자가 서버 주소, 기기 ID, 인증 토큰을 직접 입력하지 않습니다.

> 이 파일은 디버그 서명 시험용 APK입니다. 실환자 운영 배포에는 사용하지 마십시오. 중앙 관리자 승인과 시험 기기 1대의 전체 등록 흐름을 먼저 확인한 뒤, release 서명 배포본이 제공될 때까지 제한된 검증 용도로만 사용해야 합니다.
